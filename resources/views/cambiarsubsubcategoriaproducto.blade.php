    ...
    @isset (Auth::user()->rol_id)
        @if(Auth::user()->rol_id == 4)
            <div class="container-fluid" id="top">
                <div class="container">
                    <div class="">
                        {{-- <form method="GET" action="{{ route('estadoProductoSSCSelect') }}">
                            @csrf
                            ...
                            @endif --}}
                        {{-- </form> --}}
                        <form method="GET" action="{{ route('buscarListaSSCProductos') }}">
                            @csrf
            ...
            <form method="POST" action="{{ route('subsubcategriaUpdate') }}">
                @csrf
                <div class="container">
                    <table class="table table-striped table-bordered table-dark">
                        <thead>
                            <tr class="align-middle">
                                ...
                                <th scope="col">Seleccionar SSC</th>
                                <th scope="col">Seleccionar SC</th>
                            </tr>
                        </thead>
                            ...
                            <tbody>
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        ...
                                        <select id="subsubcategoria" class="form-select" name="subsubcategoria_id[]">
                                            <option selected value="{{$lp->subsubcategoria_id}}">Seleccionar subsubcategoria</option>
                                    ...
                                    <td>
                                        <select id="subcategoria" class="form-select" name="subcategoria_id[]">
                                            <option selected value="{{$lp->subcategoria_id}}">Seleccionar subcategoria</option>
